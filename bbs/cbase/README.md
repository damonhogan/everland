# Everland C*Base BBS Door

This folder contains the full door game version of Everland for C*Base BBS.
...
## Integration
- Place the PRG and loader in the C*Base doors directory
